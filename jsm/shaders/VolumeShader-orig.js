...
const VolumeRenderShader1 = {
	...
	uniforms: {
		...
		'u_data': { value: null },
		'u_cmdata': { value: null },
		'modelViewMatrix1': { value: new Matrix4().set(0) },
		'pvmMatrix1': { value: new Matrix4().set(0) }
	},

	vertexShader: /* glsl */`

		uniform mat4 modelViewMatrix1;
		uniform mat4 pvmMatrix1;
		varying vec3 nearpos;
		...
		void main() {
				...
				mat4 viewtransformf = modelViewMatrix1;
				mat4 viewtransformi = inverse(modelViewMatrix1);
	...
	fragmentShader: /* glsl */`
				...
				void main() {
						...
						//view_ray.x = 0.0000000001;
						//view_ray.y = 0.0000000001;
